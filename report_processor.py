...
# File locations
# ---------------------------------------------------------------------------
# Always work relative to the folder where this Python script is located.
# This avoids the "uploads/..." FileNotFoundError when running from VS Code.
BASE_DIR = Path(__file__).resolve().parent

# The script first looks for the source Excel file in an "uploads" folder.
# If it is not there, it also checks the same folder as this Python script.
